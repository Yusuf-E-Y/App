...
keyboard.add_hotkey('ctrl+shift+f', lambda: Generator.password(5, 5, 4))
keyboard.add_hotkey('ctrl+shift+t', lambda: Generator.password(4, 4, 4))
keyboard.add_hotkey('ctrl+shift+r', lambda: Generator.password(4, 3, 3))
keyboard.add_hotkey('ctrl+shift+e', lambda: Generator.password(3, 3, 2))
keyboard.add_hotkey('ctrl+shift+s', lambda: Generator.password(3, 2, 1))
